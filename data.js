...
const HERO_DB = {
  kimberly: {
    ...
    advice: {
      ...
      priority: "SSS",
      warning: "戦車職の中では相対的にHPが低く、前衛の保護なしで置くと集中攻撃で早期に落ちやすい弱点があります。ウィリアムズやマーフィ等の前衛でしっかりカバーする編成が前提です（theriagames/Wardawgg等）。",
      skills: {
        auto: {
          name: "エネルギー砲撃",
          effect: "ロケット弾を発射して目の前の敵を攻撃する。ロケット弾はランダムに着弾し、攻撃力×472.12%のエネルギーダメージを与える（Lv30、再使用時間1.55秒）。"
        },
        battle: {
          name: "ロケットストーム",
          effect: "ロケット弾8発を発射してランダムな敵を攻撃し、壊滅的な打撃を与える。ロケット1発につき攻撃力×286.88%のエネルギーダメージを与える（Lv30、再使用時間10秒）。"
        },
        passive: {
          name: "パワーチャージ",
          effect: "戦闘中、自身の与エネルギーダメージが+30.00%増加する（Lv30）。"
        }
      }
    }
  },
  dva: {
    ...
    advice: {
      ...
      priority: "SSS",
      warning: "バースト特化型で持続火力型ではありません。前衛の保護と削り切れる隙が揃わないと真価を発揮できず、Vortex Missileと会心率を優先し他スキルは後回しにするのがセオリーです（Packsify/LDShop等）。",
      skills: {
        auto: {
          name: "ハリケーンミサイル",
          effect: "ミサイルを1つ発射して敵を攻撃し、攻撃力×408.11%のエネルギーダメージを与える（Lv30、再使用時間1.35秒）。"
        },
        battle: {
          name: "鋼の嵐",
          effect: "最終兵器を起動させて敵全体に攻撃力×718.17%のエネルギーダメージを与える（Lv30、再使用時間10秒）。"
        },
        passive: {
          name: "武装強化",
          effect: "戦闘中、自身の会心率+30.00%（Lv30）。"
        }
      }
    }
  },
  tesla: {
    ...
    advice: {
      ...
      priority: "SS",
      warning: "後衛からの継続圧力型で、フロントラインが安定していないと真価を発揮できません。誘導電流を積み上げる時間が必要なため瞬間火力型ではなく持久戦向きで、PvPでは背後への差し込みに備えたレーダー装備もある程度必要です（LDShop等）。",
      skills: {
        auto: {
          name: "ライトニングリンク",
          effect: "アーク放電で敵を攻撃し、毎回攻撃力×408.11%のエネルギーダメージを与える（Lv30、再使用時間1.35秒）。"
        },
        battle: {
          name: "電光雷轟",
          effect: "高圧電流で最後衛の敵を3体攻撃し、攻撃力×1,127.02%のエネルギーダメージを与える（Lv30、再使用時間10秒）。"
        },
        passive: {
          name: "最大電圧",
          effect: "戦闘中、自身の与エネルギーダメージが+30.00%増加する（Lv30）。"
  ...
  murphy: {
    ...
    advice: {
      ...
      priority: "S",
      warning: "純粋な防御特化型で、自身の攻撃力は低くダメージソースにはなりません。壁として機能する一方、火力は他のアタッカーに依存する構成が前提です（theriagames/Last War Handbook等）。",
      skills: {
        auto: {
          name: "戦車砲撃",
          effect: "戦車砲で敵1体に攻撃力×490.99%の物理ダメージを与える（Lv30、再使用時間1.6秒）。"
        },
        battle: {
          name: "不動の鉄壁",
          effect: "発動後5秒間、前衛の味方全員の被物理ダメージが29.00%減少する（Lv30、再使用時間10秒）。"
        },
        passive: {
          name: "一点死守",
          effect: "戦闘中、前衛の味方全員の被ダメージが17.00%減少する（Lv30）。"
        }
      }
    }
  },
  lucius: {
    ...
    advice: {
      ...
      priority: "SS",
      warning: "エネルギーダメージ軽減のみが得意で、物理ダメージ主体の相手には効果が薄くなります。タイプ相性でもミサイルに弱いため、対面の被ダメージ種別を見極めて起用する必要があります（theriagames/Medium等）。",
      skills: {
        auto: {
          name: "トリプルライトニング",
          effect: "ランダムな敵1体（前衛優先）を攻撃、Attackの309.32%の物理ダメージ。"
        },
        battle: {
          name: "騎士道",
          effect: "発動後5秒間、味方全体の被エネルギーダメージが19.00%減少する。"
        },
        passive: {
          name: "白銀の装甲",
          effect: "戦闘中、前衛の味方の被ダメージを13.00%減少させ、エネルギーダメージの場合はさらに13.00%減少させる。"
        }
      }
    }
  },
  mcgregor: {
    ...
    advice: {
      ...
      priority: "A",
      warning: "タンク役ですが単独で前衛を張れるほどの耐久はなく、タウントが刺さった際に被弾が集中して早期に落ちるリスクがあります。副タンクとしてアダムやウィリアムズ等と組み合わせる前提の編成が推奨されています（theriagames/Pocket Gamer等）。",
      skills: {
        auto: {
          name: "勇猛突進",
          effect: "機関銃で敵を攻撃し、Attackの408.11%の物理ダメージを与える。"
        },
        battle: {
          name: "揺るがぬ意志",
          effect: "8秒間、前衛の敵2体の攻撃を自身に引き付け（挑発）、対象の攻撃力を16.50%減少させる。挑発中、対象は通常攻撃でマクレガーを優先攻撃する。"
        },
        passive: {
          name: "生命力強化",
          effect: "戦闘中、自身の被ダメージを30.00%減少する。"
        }
      }
    }
  },
  stetmann: {
    ...
    advice: {
      ...
      priority: "A",
      warning: "後衛からのAoE火力役で、単独では前線を支えられません。ウィリアムズやマーフィ等の前衛保護がないと集中砲火で崩れやすく、PvEでは高評価でもPvPでの安定性はソースにより評価が割れています（theriagames/Wardawgg等）。",
      skills: {
        auto: {
          name: "ライトニングボール",
          effect: "小さなライトニングボールを1つ発射し、経路上の敵全員に攻撃力×445.48%のエネルギーダメージを与える（Lv30、再使用時間1.45秒）。"
        },
        battle: {
          name: "雷光乱舞",
          effect: "大きなライトニングボールを3つ発射し、ボールはそれぞれランダムな敵1体に攻撃力×695.86%のエネルギーダメージを与える（Lv30、再使用時間10秒）。"
        },
        passive: {
          name: "会心強化",
          effect: "戦闘中、自身の会心率+30.00%（Lv30）。"
  ...
  schuyler: {
    ...
    advice: {
      ...
      priority: "A",
      warning: "妨害（スタン等）が主体のためPvPでは高評価ですが、PvEでは妨害効果の恩恵が薄く評価が下がりやすい傾向があります（Packsify/GrahmsGuide等）。",
      skills: {
        auto: {
          name: "エネルギー砲撃",
          effect: "敵1体にミサイルを発射、Attackの309.32%のエネルギーダメージ。"
        },
        battle: {
          name: "大大大爆撃",
          effect: "敵後衛1体を優先的に攻撃、Attackの927.52%のエネルギーダメージ。20%の確率で対象を2秒間スタンさせる（スタン中はクールダウン終了したバトルスキルが発動不能）。"
        },
        passive: {
          name: "反物質装甲",
          effect: "戦闘中、自身の攻撃力が+40.00%増加する。"
        }
      }
    }
  },
  fiona: {
    ...
    advice: {
      ...
      priority: "SS",
      warning: "ミサイル職のためタイプ相性で戦車に弱く、戦車編成が主流の環境では育成優先度が下がりがちです。相手の編成をピンポイントで対策する場面以外ではメインアタッカーとして使いにくい、という指摘もあります（NamuWiki等）。",
      skills: {
        auto: {
          name: "ダブルキス",
          effect: "車載地対空ミサイルを発射し、Attackの408.11%の物理ダメージを与える。"
        },
        battle: {
          name: "恋は盲目",
          effect: "ロケット弾を発射して敵全体を攻撃し、それぞれAttackの718.17%の物理ダメージを与える。"
        },
        passive: {
          name: "弾道強化",
          effect: "戦闘中、自身の与物理ダメージが+30.00%増加する。"
        }
      }
    }
  },
  morrison: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "全自動式機関銃",
          effect: "ガトリングで敵1体にAttackの309.32%の物理ダメージ。"
        },
        battle: {
          name: "徹甲射撃",
          effect: "ガトリングで10回攻撃、1回につきランダムな敵1体にAttackの193.38%の物理ダメージを与え、対象の防御力を9秒間5%減少させる（1体につき最大25%までスタック）。"
        },
        passive: {
          name: "最大火力",
          effect: "戦闘中、自身の与物理ダメージが+30.00%増加する。"
  ...
  swift: {
    ...
    advice: {
      ...
      priority: "B",
      warning: "装備・専用武装が整うまでは打たれ弱く、本領を発揮しにくいヒーローです。ミサイル軸にフルコミットする場合の3番手候補で、それ以外では優先度は高くありません（theriagames/Wardawgg等）。",
      skills: {
        auto: {
          name: "ピンポイント砲撃",
          effect: "残り体力の割合が最も少ない敵にロケット弾を発射し、着弾範囲内の敵にAttackの408.11%の物理ダメージを与える。"
        },
        battle: {
          name: "弱点発見",
          effect: "ランダムな敵3体にAttackの793.54%の物理ダメージを与える。"
        },
        passive: {
          name: "一発必中",
          effect: "戦闘中、自身の会心率+30.00%。"
        }
      }
    }
  },
  mason: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "ガトリング連射",
          effect: "ガトリングで敵を攻撃し、Attackの208.00%の物理ダメージを与える。"
        },
        battle: {
          name: "範囲射撃",
          effect: "ガトリングで敵を攻撃し、Attackの1,655.50%の物理ダメージを与える。"
        },
        passive: {
          name: "ゾンビ狩り",
          effect: "戦闘中、後衛の戦車英雄の対モンスター与ダメージを17.00%増加させる（対人戦では発動しない）。"
        }
      }
    }
  },
  sarah: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "銃撃の挨拶",
          effect: "敵1体を攻撃し、Attackの183.75%の物理ダメージを与える。"
        },
        battle: {
          name: "マシンガン協奏曲",
          effect: "発動後5秒間、後衛の味方3体の対モンスター与ダメージを+18.00%増加させる（対人戦では発動しない）。"
        },
        passive: {
          name: "特製装甲",
          effect: "戦闘中、自身の対モンスター被ダメージを37.00%減少させる。"
        }
      }
    }
  },
  venom: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "エネルギー弾",
          effect: "命中した敵にAttackの183.75%の継続エネルギーダメージを与える。"
        },
        battle: {
          name: "エネルギー奔流",
          effect: "前衛の敵2体を優先して攻撃し、中毒状態を付与、それぞれAttackの560.88%のエネルギーダメージを与える。"
        },
        passive: {
          name: "オーバーロック",
          effect: "戦闘中、自身の攻撃力が+30.00%増加する。"
        }
      }
    }
  },
  brats: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "ロケット乱射",
          effect: "敵1体を攻撃し、Attackの288.00%の物理ダメージを与える。"
        },
        battle: {
          name: "猛爆",
          effect: "ロケット弾を発射してランダムな敵5体を攻撃、それぞれAttackの282.45%の物理ダメージを与える。"
        },
        passive: {
          name: "ゾンビキラー",
          effect: "戦闘中、自身の対モンスター与ダメージが+37.00%増加する。"
        }
      }
    }
  },
  williams: {
    ...
    advice: {
      ...
      priority: "S",
      warning: "高火力スキルを持たず単独で攻めを完結させることはできません。範囲攻撃も弱くPvEの雑魚処理には不向きで、スタンや沈黙等の妨害を受けるとタンクとしての機能が止まるリスクがあります（theriagames等）。",
      skills: {
        auto: {
          name: "閃光手榴弾",
          effect: "閃光手榴弾で範囲内の敵に攻撃力×408.11%の物理ダメージを与える（Lv30、再使用時間1.35秒）。"
        },
        battle: {
          name: "鋼鉄の心",
          effect: "発動後10秒間、前衛の味方2体の防御力が50.00%増加する（Lv30、再使用時間10秒）。"
        },
        passive: {
          name: "フルアーマー",
          effect: "戦闘中、自身の被ダメージが30.00%減少する（Lv30）。"
        }
      }
    }
  },
  carlie: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "二連ロケット",
          effect: "敵1体を攻撃、Attackの309.32%の物理ダメージ。"
        },
        battle: {
          name: "ファイアサプライズ",
          effect: "敵全体にAttackの183.26%の物理ダメージを与え、対象の与エネルギーダメージを5秒間15.00%減少させる。"
        },
        passive: {
          name: "適応能力",
          effect: "戦闘中、自身の被エネルギーダメージを40.00%減少する。"
        }
      }
    }
  },
  adam: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "MK43車載機関銃",
          effect: "ランダムな敵1体にAttackの309.32%の物理ダメージを与える。"
        },
        battle: {
          name: "防御反撃",
          effect: "発動後8.80秒間「防御反撃」状態になり、ダメージを受けるたびに通常攻撃で反撃する（毎秒最大1回）。"
        },
        passive: {
          name: "茨の装甲",
          effect: "戦闘中、前衛の味方の被ダメージを13.00%減少させる。「防御反撃」状態のロケラン英雄への効果は2倍になる。"
        }
      }
    }
  },
  scarlett: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "火炎噴射",
          effect: "火炎放射器で敵を攻撃し、Attackの735.75%の物理ダメージを与える。"
        },
        battle: {
          name: "鉄壁防御",
          effect: "発動後9秒間、自身のモンスターからの被ダメージを34.00%減少させる（対人戦では発動しない）。"
        },
        passive: {
          name: "T-5型装甲",
          effect: "戦闘中、自身の防御力+100.00%。"
        }
      }
    }
  },
  violet: {
    ...
    advice: {
      ...
      skills: {
        auto: {
          name: "毒霧噴射",
          effect: "敵に毒ガスを噴射し続け、毎回Attackの300.00%の物理ダメージを与える。"
        },
        battle: {
          name: "有毒ガス",
          effect: "前衛の敵2体を優先的に攻撃し、Attackの642.75%の物理ダメージを与える。4秒間、対象の攻撃力を6%減少させる。"
        },
        passive: {
          name: "Z型装甲",
          effect: "戦闘中、自身の対モンスター被ダメージを37.00%減少させる。"
  ...
  marshall: {
    ...
    advice: {
      ...
      priority: "S",
      warning: "本人のステータスは低めで、★4未満では性能を十分発揮できません。★4に届くまではメイソン等のSSRを優先する方が効率的、という指摘もあります（NamuWiki等）。",
      skills: {
        auto: {
          name: "三重奏",
          effect: "車載機関銃で経路上の敵にAttackの381.47%のエネルギーダメージ。"
        },
        battle: {
          name: "戦術指揮",
          effect: "発動後6秒間、味方全体の攻撃力が+16.50%増加する。"
        },
        passive: {
          name: "高速起動",
          effect: "戦闘中、自身のスキルヘイストが+30.00%増加し、攻撃力が最も高い味方1体の被ダメージを12.00%減少させる。"
        }
      }
    }
  },
