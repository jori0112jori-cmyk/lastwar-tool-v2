  ...
  kimberly: {
    ...
    milestones: [
      { id:'unlock', starMin:-1, starMax:-1, to:'0-1', shardCost:50, named:true,
        ...
        verdict:'S6最優先。専用かけら50個でキムが別次元の強さに（packsify）' },
      { id:'star1', starMin:0, starMax:0, to:'1-0', shardCost:80, named:false,
        powerGain:'large', costpa:7, immediacy:8,
        note:'自動「決意」状態発動（会心率+10%）。開幕から全力モードに',
        verdict:'★1の自動決意発動は対人戦で体感しやすい（cpt-hedge）' },
      { id:'star3', starMin:1, starMax:2, to:'3-0', shardCost:550, named:false,
        powerGain:'xlarge', costpa:5, immediacy:9,
        note:'エネルギー増幅2スタック先行獲得→最大30発が現実的に。最重要マイルストーン',
        verdict:'★3がキム覚醒の本番。火力が2倍近くなる実感あり（packsify/Reddit）' },
      { id:'star5', starMin:3, starMax:4, to:'5-0', shardCost:900, named:false,
        powerGain:'mid', costpa:3, immediacy:7,
        note:'増幅スタックごとに追加1発。追加ダメージ合計+60%。長期目標向け',
        verdict:'★5は急がず★3後に余裕があれば（cpt-hedge）' },
    ],
  },
  dva: {
    skillName: 'エーススター',
